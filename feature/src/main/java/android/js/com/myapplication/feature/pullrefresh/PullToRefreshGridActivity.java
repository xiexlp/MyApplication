...
public final class PullToRefreshGridActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPullRefreshGridView.setOnRefreshListener(new OnRefreshListener2<GridView>() {
			...
			public void onPullDownToRefresh(PullToRefreshBase<GridView> refreshView) {
				...
				System.out.println("时间:"+label);
						...
						Toast.makeText(PullToRefreshGridActivity.this, "下拉刷新Pull Down!", Toast.LENGTH_SHORT).show();
				new GetDataTask().execute();
			}

			@Override
			public void onPullUpToRefresh(PullToRefreshBase<GridView> refreshView) {
				Toast.makeText(PullToRefreshGridActivity.this, "上拉刷新Pull Up!", Toast.LENGTH_SHORT).show();
				new GetDataTask().execute();
			}
		...
		tv.setText("集合还没有下载Empty View, Pull Down/Up to Add Items");
		mPullRefreshGridView.setEmptyView(tv);

		mAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, mListItems);
		mGridView.setAdapter(mAdapter);

		titleView=findViewById(R.id.title_grid_view);

		titleView.setText("grid view pull to refresh ");
	}
