...
//
//				Toast.makeText(PullToRefreshListActivity.this, "下拉刷新Pull Down!", Toast.LENGTH_SHORT).show();
//				new GetDataTask().execute();
//			}
//
//			@Override
...
//
//				System.out.println("沙拉上拉监听");
//				Toast.makeText(PullToRefreshListActivity.this, "上拉刷新Pull Up!", Toast.LENGTH_SHORT).show();
//				new GetDataTask().execute();
//			}
//
//		});
		...
		mPullRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
			...
			public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
				...
				Toast.makeText(PullToRefreshListActivity.this, "上拉刷新111Pull Up!", Toast.LENGTH_SHORT).show();
				new GetDataTask().execute();
			}
...
//				Toast.makeText(PullToRefreshListActivity.this, "滑到最后一条End of List!", Toast.LENGTH_SHORT).show();
//			}
//		});
		...
		titleView.setText("测试pull to refresh list view");
		//设置上拉刷新或者下拉刷新
...
//			}
			...
			//mListItems.addFirst("Added after refresh 添加的数据...");
			//mListItems.addAll(Arrays.asList(result));

			//mListItems.addFirst("数据刷新请求的数据....");
			//mListItems.addLast("数据下拉刷新得到的数据................");
			//mListItems.addAll(Arrays.asList(result));
